...
;(() => {
  ...
  let sendPointsForm
  let logoutButton
  let fraudFlagsTableBody; // Add this line
  ...
  function initializeDashboardElements() {
    ...
    fraudFlagsTableBody = document.getElementById("fraud-flags-table-body"); // Add this line
  }
    ...
    try {
      switch (sectionId) {
        ...
        case "redemption-requests-section":
          ...
          break
        case "fraud-management-section": // Add this case
